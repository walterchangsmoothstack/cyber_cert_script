...
def extractPDFText(filename: str):
...
def removeUnwantedStrings(textList, unwantedStrings):
    newTextList = []
...
def getCertificateCompletionData(filename: str):
    ...
    textList = extractPDFText(filename)
    textList = removeUnwantedStrings(textList, unwantedStrings)
    return textList

def extractCertificateDataFromDirectory(directoryname):
    ...
    for filename in os.listdir(directoryname):
        ...
        print(getCertificateCompletionData(os.path.join(directoryname, filename)))